...
layui.define(['laypage', 'form'], function (exports) {
    ...
    IconFonts.prototype.render = function(options){
        ...
        layui.link(layui.cache['contentPath']+"/plugins/font-awesome/css/font-awesome.min.css");//font-awesome图标css
        layui.link(layui.cache['contentPath']+"/plugins/layui/css/layui.css");//layui_css
        var a = {
            init: function () {
