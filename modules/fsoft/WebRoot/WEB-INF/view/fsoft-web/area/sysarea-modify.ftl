...
<html>
	            ...
	            <form class="layui-form layui-form-pane" action="" method="post">
	                ...
	                <div class="layui-form-item">
	                    ...
	                    <div class="layui-input-block">
	                    	<div id="xm-select-Area" class="xm-select-demo"></div>
	                    </div>
	                </div>
	                <div class="layui-form-item">
	                ...
	                <div class="layui-form-item">
	                    ...
	                    <div class="layui-input-block">
	                        <input class="layui-input" type="text" id="postCode" name="postCode" value="${model.postCode}" autocomplete="off">
	                    </div>
	                </div>
	                <div class="layui-form-item">
	                    <label for="name" class="layui-form-label">
	                    ...
	                    <div class="layui-input-block">
	                        <input class="layui-input" type="text" id="areaCode" name="areaCode" value="${model.areaCode}" autocomplete="off">
	                    </div>
	                </div>
	                <div class="layui-form-item">
	                    <label for="name" class="layui-form-label">
	...
	<script type="text/javascript" src="${request.contextPath}/static/fsoft-web/area/sysarea-modify.js?v=202002"></script>
</html>
