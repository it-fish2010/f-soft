package com.fish.core.org.service.impl;
...
import com.fish.core.org.mapper.OrganizeMapper;
...
public class OrganizeServiceImpl implements OrganizeService {
	...
	public void save(Organize organize) {
		if (OgnlUtils.isEmpty(organize.getOrgId()))
			organize.setOrgId(UUIDUtils.randomUpperCaseId());
		if (StringUtils.isBlank(organize.getParentOrgId())) {
